...
echo "  1.) Mozesz uzyc tilde expansion przy podaniu sciezki"
echo "  2.) Wprowadzona nazwa rozszerzenia nie moze zawierac '.'"
echo "  3.) Nie mozna wprowadzic nazwy pliku jako liczba '0'"
echo "  4.) Skrypt zawiera jedynie podstawowa walidacje"
echo -e "  5.) Nazwa pliku musi zawierac min. jeden znak\n  oraz nie moze zawierac m.in. '.' w nazwie"
echo " "
echo "========================================================"
echo " "
